...
6. **משפטים שבורים או חסרי נושא** — משפט שנראה כתוצר של דחיסה/עריכה חלקית: חסר נושא ברור, פועל תלוי-באוויר, או צירוף מילים שלא מרכיב משפט תקין דקדוקית. אם אי-אפשר לזהות "מי עושה מה" בקריאה ראשונה — דגל. **חל במלואו גם על דיאלוג מצוטט של דמויות (טקסט בתוך מירכאות)**: חיקוי "מקראי"/ארכאי עם תחביר שבור איננו סגנון לגיטימי אלא שגיאה (למשל "אחת אבן"→"אבן אחת", "וולא יש הגנה"→"ואין הגנה", משפט פסאודו-עתיק שאינו מובן בקריאה ראשונה). ב-correction נסח מחדש בעברית תקנית תוך שמירת התוכן והדובר. (ציטוט מקור אמיתי ומדויק — כמו פסוק תנ"כי — תקין ואינו מדוגל.)
