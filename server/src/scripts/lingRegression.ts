...
const CASES: Case[] = [
  ...
  /* 4. חזרתיות — נבדק בזוג הסצנות repeat_a/repeat_b (פתיח ניטרלי, לא ביטוי אסור) */
  { id: 'repeat_a', kind: 'control', label: 'פתיח-מעבר, מופע ראשון (לגיטימי)',
    narrative: 'אתם מגיעים אל שער העיר.', drHoloDialog: 'בואו נעצור רגע ונחשוב ביחד: העיר מוקפת חומה כדי להגן על התושבים.' },
  { id: 'repeat_b', kind: 'fail', label: 'חזרתיות: אותו פתיח-מעבר פעם שנייה',
    narrative: 'בשוק אתם רואים דוכנים.', drHoloDialog: 'בואו נעצור רגע ונחשוב ביחד: בשוק החליפו סחורה בסחורה עוד לפני הכסף.' },
  /* 4ב. ביטויי-הכרזה קלישאתיים (הנוסחאות הקבועות שבוטלו) */
  { id: 'banned_phrase', kind: 'fail', label: 'ביטוי-הכרזה אסור (תנו לי להסביר בעברית פשוטה)',
    narrative: 'אתם נכנסים למקדש.', drHoloDialog: 'תנו לי להסביר את זה בעברית פשוטה: המקדש היה מרכז החיים בעיר.' },
  { id: 'banned_phrase2', kind: 'fail', label: 'ביטוי-הכרזה אסור (השורה התחתונה היא)',
    narrative: 'המסע מסתיים.', drHoloDialog: 'השורה התחתונה היא שהמסחר חיבר בין העולמות.' },
