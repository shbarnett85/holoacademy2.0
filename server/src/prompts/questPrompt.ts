...
**4. כתוב מהמהות — אל תכווץ:** נסח כל שקופית **מחדש מאפס** ברמת היעד. שמור על **כל העובדות, השמות והמושגים המרכזיים** (תאריך/שם/אירוע ספציפי כמו 1588 או דרייק לא נעלמים בשם "פישוט") — אך **חופש מלא בניסוח, במבנה ובתחביר**. אל תיקח ניסוח עשיר ו"תקצץ" אותו: כיווץ משאיר שברים — תחביר גבוה שנשבר, מושג תלוי, חצי-משפט. ספר את אותו רעיון **מחדש** בשפה טבעית של הרמה. **אל תיפול לקצב מקראי/ספרותי גם כשהטקסט פשוט** — כתוב "חזרו בלי תשובה", לא "ובידיהם לא תשובה". ברמות נמוכות שמירת-המהות = **העובדה הקונקרטית** (הסר מושגים מופשטים); ברמות גבוהות = מלוא העומק.
...
- **התאמת מין ומספר (קריטי)**: ודא התאמה דקדוקית מלאה בין שם העצם לפועל/לתואר/למילת-השאלה המתייחסים אליו. שם עצם נקבה → פועל ותואר נקבה (גלקסיה **שוקלת** לא "שוקל"; "**איזה** אור" לא "איזו"; "המים **זורמים**"). שם עצם רבים → פועל רבים. בדוק כל משפט.
