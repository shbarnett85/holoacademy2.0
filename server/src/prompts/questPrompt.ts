...
כללי שימוש:
- **טבעיות לפני כמות**: 1-2 ביטויים לסצנה לכל היותר, ביטוי שונה בכל סצנה, במקום שבו הם באמת משרתים את ההסבר. "הנה מה שאני רוצה ש..." ו"השורה התחתונה היא" שמורים לשיא ולסיומים.
- הביטוי הוא **פתיח למשפט בעל תוכן**, לא סיסמה: אחרי "דמיינו את זה" באה תמונה מילולית קונקרטית; אחרי "השורה התחתונה היא" — מסקנה חדה אחת.
- הניסוח **בדיוק בצורת הפנייה** שנקבעה למעלה — בלי וריאציות בצורה אחרת.`
}
