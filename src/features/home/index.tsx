...
export default function Home() {
  ...
  return (
    <HoloBackdrop>
      ...
      {/* "איך זה עובד" — לפני המדף: קודם מבינים, אחר כך מתנסים */}
      <div style={{ width: '100%', maxWidth: 960, marginTop: 40, padding: '0 20px', boxSizing: 'border-box', position: 'relative', zIndex: 1 }}>
      ...
      {showcase.length > 0 ? (
        <div style={{ marginTop: 44, marginBottom: 70, width: '100%', maxWidth: 1060, padding: '0 20px', boxSizing: 'border-box', position: 'relative', zIndex: 1 }}>
